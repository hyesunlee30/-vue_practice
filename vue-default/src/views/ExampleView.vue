<template>
  <div>
    ...
    <div class="container" v-bind:class="[activeClass, redClass]">Class2</div>
...
export default {
  data() {
    return {
      ...
      baseStyle: "background-color:green; wudth:100%; height:200px",
  ...
  methods: {
    callChildFunc() {
      ...
      this.$refs.child_component.msg = "부모가 바꾼 데이터";
    },
    sendMessage(data) {
      alert(data);
    },
